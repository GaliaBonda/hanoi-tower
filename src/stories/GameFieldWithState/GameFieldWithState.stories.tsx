...
const Template: ComponentStory<typeof GameFieldWithState> = (args) => (
  <GameFieldWithState {...args} />
);
...
FiveDiscsGame.args = {
  ...
  stacks: {
    stack1: {
      stack: RodStories.FiveDiscsRod.args?.stack || new Stack([]),
      id: 1,
    },
    stack2: { stack: new Stack([]), id: 2 },
    stack3: { stack: new Stack([]), id: 3 },
...
export const WithWinPopupToggled = Template.bind({});
WithWinPopupToggled.args = {
  ...Standart.args,
  winPopup: false,
};
...
TopDiscOnSecondRod.args = {
  ...
  stacks: {
    stack1: {
      stack: new Stack(startStack.getArray().slice(0, startStack.size() - 1)),
      id: 1,
    },
    stack2: {
      stack: new Stack([startStack.getArray()[startStack.size() - 1]]),
      id: 2,
    },
    stack3: { stack: new Stack([]), id: 3 },
  },
